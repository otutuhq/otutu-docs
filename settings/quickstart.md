...
📸 **Image Placeholder:** Basic information form screenshot

* **Email Address:** Primary business email for client communications
...
📸 **Image Placeholder:** Currency configuration screenshot

* **Primary Currency:** Main business currency (USD, EUR, GBP, etc.)
...
📸 **Image Placeholder:** Date/time format screenshot
...
📸 **Image Placeholder:** Fiscal year & number formatting screenshot
...
📸 **Image Placeholder:** Template selection screenshot

* **Template Style:** Choose available layouts
* **Live Preview:** See changes in real-time
* **Template Types:** Different layouts for invoices, bills, estimates

#### 5. Configure Column Labels

📸 **Image Placeholder:** Custom field label configuration screenshot

* **Item Name:** Customize product/service column label
