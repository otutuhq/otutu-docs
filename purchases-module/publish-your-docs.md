...
📸 **Image Placeholder:** Purchases menu with Bills option highlighted
...
📸 **Image Placeholder:** Bill details form
...
* Save the bill – it automatically creates accounting entries
...
📸 **Image Placeholder:** Bulk payment interface
